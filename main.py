...
if __name__ == "__main__":
	...
	fraction_activated(seed_set=non_target_nodes, seed_func=degree_seed, node_positions=node_positions, f=independent_cascade, g=g, M_step=100, M_end=1000, M_start=100, message='experiment5', target_nodes=raunaq_target_nodes, savefig=True)

	# expt 6
	fraction_activated(seed_set=non_target_nodes, seed_func=degree_seed, node_positions=node_positions, f=linear_threshold, g=g, M_step=100, M_end=1000, M_start=100, message='experiment6', target_nodes=raunaq_target_nodes, savefig=True)
